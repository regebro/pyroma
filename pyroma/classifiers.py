...
LICENSE_CODES = {
    ...
    "License :: OSI Approved :: GNU General Public License v2 (GPLv2)": {"GPLv2", "GPL"},
    "License :: OSI Approved :: GNU General Public License v2 or later (GPLv2+)": {"GPL", "GPLv2+"},
    "License :: OSI Approved :: GNU General Public License v3 (GPLv3)": {"GPLv3", "GPL"},
    "License :: OSI Approved :: GNU General Public License v3 or later (GPLv3+)": {"GPLv3+", "GPL"},
